...
function getGenAI() {
  ...
  if (!apiKey) {
    throw new Error("GEMINI_API_KEY is not configured on the server. Please add your GEMINI_API_KEY in the AI Studio Settings menu (under Secrets) or set it in your environment variables.");
  }
